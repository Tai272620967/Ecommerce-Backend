        ...
        http
            ...
            .authorizeHttpRequests(
                authz -> authz
                    ...
                    .requestMatchers("/", "/api/v1/auth/login", "/api/v1/auth/refresh", "/api/v1/users/register", "/api/v1/categories/*", "/api/v1/categories/sub-category/*", "/api/v1/sub-categories",  "/api/v1/sub-categories/main-category/*", "/api/v1/sub-categories/*", "/api/v1/main-categories", "/api/v1/chatbot/**", "/uploads/images/**", "/storage/**").permitAll()
